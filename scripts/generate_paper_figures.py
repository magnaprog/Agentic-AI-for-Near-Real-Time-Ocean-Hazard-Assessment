...
STATION_META: list[tuple[str, int, float, float]] = [
    ...
    ("46403", 4830, 52.647, -156.94),
    ("46411", 7480, 39.337, -127.04),
]
...
CHILE_STATION_META: list[tuple[str, int, float, float]] = [
    ...
    ("46412", 9080, 32.4, -120.582),
    ("46411", 10040, 39.337, -127.04),
    ("51407", 10740, 19.53, -156.601),
...
def fig_multi_source_network_map() -> None:
    ...
    dart_stations: dict[str, tuple[float, float]] = {
        # NW Pacific
        "21413": (30.515, 152.117),    # Izu-Bonin
        "21414": (48.97, 178.165),    # South of Adak
        "21415": (50.12, 171.867),    # South of Attu, AK
        "21416": (48.126, 163.355),    # SE of Kamchatka
        "21418": (38.73, 148.8),    # NE of Tokyo
        "21419": (44.401, 155.653),    # SE of Kuril Islands
        "21420": (28.91, 135.0),    # Philippine Sea
        # Indian Ocean
        "23401": (8.861, 88.558),      # Bay of Bengal
        "23461": (9.500, 95.600),      # Andaman Sea
        # SE Pacific
        "32401": (-20.442, -73.422),   # Off northern Chile
        "32402": (-26.735, -73.978),   # Off central Chile
        "32411": (4.979, -90.793),     # East Pacific
        ...
        "43412": (16.012, -107.004),   # Off Mexico
        "43413": (10.927, -100.012),   # Off Central America
        # NW Atlantic
        "44402": (39.287, -70.633),    # NW Atlantic
        "44403": (41.915, -61.590),    # NW Atlantic
        # Aleutian / Gulf of Alaska
        "46402": (50.913, -164.147),   # Aleutian
        "46403": (52.647, -156.94),   # Aleutian
        "46404": (45.87, -128.756),   # Cascadia
        "46407": (42.704, -128.895),   # Oregon
        "46408": (49.677, -169.825),   # Aleutian
        "46409": (55.338, -148.575),   # SE Kodiak, AK
        "46410": (57.633, -143.843),   # Gulf of Alaska
        "46411": (39.337, -127.04),   # Cape Mendocino
        "46413": (48.042, -173.942),   # South of Adak
        "46414": (53.764, -152.416),   # SE Chirikof, AK
        "46415": (52.975, -139.94),   # Gulf of Alaska
        "46416": (49.939, -134.427),   # West of Vancouver, BC
        "46419": (48.815, -129.623),   # WNW of Seattle, WA
        # Hawaii / South Pacific
        "51407": (19.53, -156.601),   # Hawaii
        "51425": (-9.511, -176.258),   # South Pacific
        # Western Pacific / Micronesia
        "52401": (19.285, 155.739),    # Marianas
        "52402": (11.928, 153.876),    # Micronesia
        "52403": (4.018, 145.628),     # Micronesia
        "52404": (20.627, 132.144),    # Philippine Sea
        "52405": (13.034, 132.151),    # Philippine Sea
        "52406": (-5.371, 164.985),    # Solomon Islands
    }
...
ILLAPEL_STATION_META: list[tuple[str, int, float, float]] = [
    ...
    ("51426", 9280, -23.11, -168.385),
    ("46411", 9740, 39.337, -127.04),
    ("46407", 10110, 42.704, -128.895),
    ("46403", 12450, 52.647, -156.94),
]
...
IQUIQUE_STATION_META: list[tuple[str, int, float, float]] = [
    ("32401", 295, -20.442, -73.422),
    ("32402",   858, -26.733, -73.980),
    ("32412", 1652, -17.984, -86.374),
    ("32413", 2803, -7.407, -93.517),
    ("51426", 9900, -23.11, -168.385),
    ("46403", 11476, 52.647, -156.94),
]
...
SAMOA_STATION_META: list[tuple[str, int, float, float]] = [
    ...
    ("51426", 935, -23.11, -168.385),
    ("54401", 1960, -33.109, -173.155),
    ("51407", 4250, 19.53, -156.601),
    ("46411", 7680, 39.337, -127.04),
    ("46403", 7720, 52.647, -156.94),
]
